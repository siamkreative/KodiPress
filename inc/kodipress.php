...
function kodipress_styles() {
	...
	wp_enqueue_style( 'kodipress-styles', get_stylesheet_directory_uri() . '/app.css' );
	...
	wp_enqueue_script( 'kodipress-scripts', get_template_directory_uri() . '/app.js', array( 'jquery' ), '1.0.0', true );
}
